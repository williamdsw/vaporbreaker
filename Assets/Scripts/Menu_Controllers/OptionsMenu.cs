...
public class OptionsMenu : MonoBehaviour
{
    ...
    private void BindingClickEvents()
    {
        ...
        valueButtons[0].onClick.AddListener(() =>
        {
        ...
        valueButtons[1].onClick.AddListener(() =>
        {
        ...
        valueButtons[2].onClick.AddListener(() =>
        {
        ...
        valueButtons[3].onClick.AddListener(() =>
        {
        ...
        allOtherButtons[0].onClick.AddListener(() =>
        {
        ...
        allOtherButtons[1].onClick.AddListener(() =>
        {
            allMenus[1].SetActive(false);
        ...
        // BINDINGS MENU
        allOtherButtons[2].onClick.AddListener(() =>
        {
            allMenus[1].SetActive(false);
        ...
        // BACK BUTTON
        allOtherButtons[3].onClick.AddListener(() =>
        {
            allMenus[1].SetActive(false);
        ...
        {
            allOtherButtons[index].onClick.AddListener(() =>
            {
    ...
    private void GetResolutions()
    {
        ...
        foreach (string value in resolutionsString.Split('|'))
        {
    ...
    private void UpdateUI()
    {
        string[] values = 
        {
            actualResolution, (isFullscreen ? "Yes" : "No"), 
            string.Concat(BGMVolume * 100, "%"), string.Concat(SFXVolume * 100, "%")
        };

        for (int index = 0; index < valueButtonsTexts.Count; index++)
        {
            valueButtonsTexts[index].text = values[index];
        }
    }
}