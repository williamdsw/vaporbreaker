...
public class DefaultLayoutMenu : MonoBehaviour
{
    ...
    public void TranslateLabels ()
    {
        ...
        for (int index = 0; index < keyboardLabels.Count; index++) { keyboardUILabels[index].SetText (keyboardLabels[index]); }
        ...
        for (int index = 0; index < gamepadLabels.Count; index++) { gamepadUILabels[index].SetText (gamepadLabels[index]); }
    }
}