...
public class MainMenu : MonoBehaviour
{
    ...
    private void BindingClickEvents ()
    {
        ...
        // NO BUTTON
        questionAnswerButtons[0].onClick.AddListener (delegate
        {
        ...
        // YES BUTTON
        questionAnswerButtons[1].onClick.AddListener (delegate
        {
        ...
        // QUIT GAME
        allButtons[8].onClick.AddListener (delegate
        {
    ...
    public void TranslateLabels ()
    {
        ...
        foreach (string label in localizationController.GetMainMenuLabels ()) { labels.Add (label); }
        foreach (string label in localizationController.GetProgressLabels ()) { labels.Add (label); }
