...
namespace Utilities
{
    ...
    public class PlayerProgress
    {
        ...
        public List<DateTime?> GetLastTimePlayedList()
        {
            return lastTimePlayedList;
        }
        ...
        public void SetLastTimePlayedList(List<DateTime?> lastTimePlayedList)
        {
            this.lastTimePlayedList = lastTimePlayedList;
        }
